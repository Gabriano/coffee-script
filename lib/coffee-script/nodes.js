...
(function() {
  var Access, Arr, Assign, Base, Block, Call, Class, Closure, Code, CodeFragment, Comment, Existence, Extends, For, IDENTIFIER, IDENTIFIER_STR, IS_STRING, If, In, Index, LEVEL_ACCESS, LEVEL_COND, LEVEL_LIST, LEVEL_OP, LEVEL_PAREN, LEVEL_TOP, Literal, METHOD_DEF, Macro, NEGATE, NO, Obj, Op, Param, Parens, RESERVED, Range, Return, SIMPLENUM, STRICT_PROSCRIBED, Scope, Slice, Splat, Switch, TAB, THIS, Throw, Try, UTILITIES, Value, While, YES, addLocationDataFn, compact, del, ends, extend, flatten, fragmentsToText, last, locationDataToString, merge, multident, some, starts, throwSyntaxError, unfoldSoak, utility, _ref, _ref1, _ref2, _ref3,
  ...
  exports.Macro = Macro = (function(_super) {
    ...
    function Macro(name, paramList, body) {
      this.name = name;
      this.paramList = paramList || [];
      this.body = body || new Block;
    }

    Macro.prototype.children = ['params', 'body'];

    Macro.prototype.jumps = NO;

    Macro.prototype.makeMacro = function(name, params, body) {
      return "macro " + name + " {\n  case (" + params + ") => {\n      " + body + "\n  }\n}";
    };

    Macro.prototype.compileNode = function(o) {
      var bodyText, i, p, paramStr, _i, _len, _ref4;
      paramStr = "";
      _ref4 = this.paramList;
      for (i = _i = 0, _len = _ref4.length; _i < _len; i = ++_i) {
        p = _ref4[i];
        if (i) {
          paramStr += " , ";
        }
        this.paramList[i] = p.compileToFragments(o);
        paramStr += fragmentsToText(this.paramList[i]);
        paramStr += ":expr";
      }
      bodyText = fragmentsToText(this.body.compileToFragments(o));
      return [this.makeCode(this.makeMacro(this.name, paramStr, bodyText.slice(0, -1)))];
    };
