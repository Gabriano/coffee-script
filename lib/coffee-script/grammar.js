...
(function() {
  ...
  grammar = {
    ...
    Expression: [o('Value'), o('Invocation'), o('Code'), o('Macro'), o('Operation'), o('Assign'), o('If'), o('Try'), o('While'), o('For'), o('Switch'), o('Class'), o('Throw')],
    Block: [
    ...
    Macro: [
      o('PARAM_START ParamList PARAM_END MacroGlyph Block', function() {
        return new Macro($2($5));
      }), o('MacroGlyph Block', function() {
        return new Macro([]($2));
      })
    ],
    MacroGlyph: [
