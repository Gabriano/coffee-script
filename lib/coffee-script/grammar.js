...
(function() {
  ...
  grammar = {
    ...
    Expression: [o('Macro'), o('Value'), o('Invocation'), o('Code'), o('Operation'), o('Assign'), o('If'), o('Try'), o('While'), o('For'), o('Switch'), o('Class'), o('Throw')],
    Block: [
    ...
    Macro: [
      o('MACRO_IDENTIFIER = PARAM_START ParamList PARAM_END MacroGlyph Block', function() {
        return new Macro($1($4($7)));
      }), o('MACRO_IDENTIFIER = MacroGlyph Block', function() {
        return new Macro($1([]($4)));
      })
    ],
    MacroGlyph: [
      o('|>', function() {
